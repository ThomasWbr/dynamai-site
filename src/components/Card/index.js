...
const cards = [
    { id: 1, titulo: "Diária Express", descricao: string1, cor: cor1},
    { id: 2, titulo: "Actae", descricao: string2, cor: cor1},
    { id: 3, titulo: "Tablinum", descricao: string3, cor: cor2}
]
...
function Card() {
    return (
        <div className="cardContainer">
            {cards.map(
                (c) => (<CreateCard key={c.id} titulo={c.titulo} descricao={c.descricao} cor={c.cor}/>)
            )}
        </div>
    )
}
